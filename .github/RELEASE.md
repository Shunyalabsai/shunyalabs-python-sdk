...
This document outlines the release process for the Shunyalabs Python SDK packages.

## Overview

The Shunyalabs Python SDK repository contains two separate packages:
- `shunyalabs-rt` - Real-Time API Client
- `shunyalabs-batch` - Batch API Client
- `shunyalabs-flow` - Flow API Client
...
2. **Automated Workflow**
   ...
   - Update version in `sdk/rt/Shunyalabs/rt/__init__.py`
   - Build the package
   - Publish to PyPI

3. **Manual Steps After Release**
   - Verify the package is available on PyPI
   - Test installation: `pip install shunyalabs-rt==1.0.0`
...
2. **Automated Workflow**
   ...
   - Run comprehensive tests across Python versions
   - Update version in `sdk/batch/Shunyalabs/batch/__init__.py`
   - Build the package
   - Publish to PyPI

3. **Manual Steps After Release**
   - Verify the package is available on PyPI
   - Test installation: `pip install shunyalabs-batch==1.0.0`
   - Update GitHub release notes
   - Announce the release
...
2. **Automated Workflow**
   ...
   - Run comprehensive tests across Python versions
   - Update version in `sdk/flow/Shunyalabs/flow/__init__.py`
   - Build the package
   - Publish to PyPI

3. **Manual Steps After Release**
   - Verify the package is available on PyPI
   - Test installation: `pip install shunyalabs-flow==1.0.0`
   - Update GitHub release notes
   - Announce the release
