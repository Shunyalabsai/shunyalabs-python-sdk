...
This guide helps users migrate from the legacy Shunyalabs Flow Client (`shunyalabs-flow`) to the new Shunyalabs Flow SDK (`shunyalabs-flow`). The new SDK provides a cleaner API, better error handling, and improved performance.
...
```python
from shunyalabs_flow.client import WebsocketClient
from shunyalabs_flow.models import (
    ConnectionSettings,
    Interaction,
    AudioSettings,
    ConversationConfig,
...
```python
from shunyalabs.flow import AsyncClient, AudioFormat, ConversationConfig
...
```python
from shunyalabs_flow.client import WebsocketClient
from shunyalabs_flow.models import ConnectionSettings
...
```python
from shunyalabs.flow import AsyncClient, JWTAuth, ConnectionConfig
...
1. Check the [Flow SDK documentation](https://docs.Shunyalabs.com/sdk/flow-python-sdk)
2. Review the [examples directory](https://github.com/Shunyalabs/Shunyalabs-python-sdk/tree/main/examples/flow)
3. Contact support at support@Shunyalabs.com
