"""
Transport layer for Shunyalabs Flow WebSocket communication.

This module provides the Transport class that handles low-level WebSocket
communication with the Shunyalabs Flow API, including connection management,
...
class Transport:
    """
    WebSocket transport layer for Shunyalabs Flow API communication.

    This class handles all low-level WebSocket communication with the Shunyalabs
    ...
    def __init__(
        ...
        Args:
            url: The base URL for the Shunyalabs Flow API.
    ...
    async def connect(self, ws_headers: Optional[dict] = None) -> None:
        """
        Establish WebSocket connection to the Shunyalabs Flow API.
    ...
    async def receive_message(self) -> Union[dict, bytes]:
        ...
        Returns:
            ...
            received from the Shunyalabs Flow API.
