# Shunyalabs Batch API Client

[![PyPI](https://img.shields.io/pypi/v/shunyalabs-batch)](https://pypi.org/project/shunyalabs-batch/)
![PythonSupport](https://img.shields.io/badge/Python-3.9%2B-green)

Async Python client for Shunyalabs Batch API.
...
- Full job configuration support with all Shunyalabs features
...
```python
import asyncio
from shunyalabs.batch import AsyncClient

async def main():
    # Create a client using environment variable SHUNYALABS_API_KEY
...
```python
from shunyalabs.batch import AsyncClient, JWTAuth
...
```python
import asyncio
from shunyalabs.batch import AsyncClient, JobConfig, JobType, TranscriptionConfig
...
```python
import asyncio
from shunyalabs.batch import AsyncClient, JobStatus
...
```python
import asyncio
from shunyalabs.batch import AsyncClient, FormatType
...
```python
import asyncio
from shunyalabs.batch import AsyncClient, ConnectionConfig
