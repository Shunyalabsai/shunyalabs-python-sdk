"""
Asynchronous client for Shunyalabs batch transcription.

This module provides the main AsyncClient class that handles batch
speech-to-text transcription using the Shunyalabs Batch API.
"""
...
class AsyncClient:
    """
    Asynchronous client for Shunyalabs batch speech transcription.

    This client provides a full-featured async interface to the Shunyalabs Batch API,
