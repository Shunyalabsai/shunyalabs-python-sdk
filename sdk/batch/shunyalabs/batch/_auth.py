...
class StaticKeyAuth(AuthBase):
    ...
    Args:
        api_key: The Shunyalabs API key.
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        if not self._api_key:
            raise ValueError("API key required: provide api_key or set SHUNYALABS_API_KEY")
...
class JWTAuth(AuthBase):
    ...
    Args:
        api_key: The main Shunyalabs API key used to generate JWTs.
    ...
    def __init__(
        ...
        *,
        ...
        if not self._api_key:
            raise ValueError(
                "API key required: please provide api_key or set SHUNYALABS_API_KEY environment variable"
            )
    ...
    async def _generate_token(self) -> str:
        try:
            ...
            raise ImportError(
                "aiohttp is required for JWT authentication. Please install it with `pip install 'shunyalabs-batch[jwt]'`"
            )
