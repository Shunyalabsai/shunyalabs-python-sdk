"""
Models for the Shunyalabs Batch SDK.

This module contains all data models, enums, and configuration classes used
throughout the Shunyalabs Batch Speech Recognition SDK. These models
provide type-safe interfaces for configuration, job management, and
result handling based on the official Shunyalabs API schema.
"""
...
class JobConfig:
    ...
    available features and settings supported by the Shunyalabs API.
...
class JobDetails:
    ...
    by the Shunyalabs API, including timestamps, configuration, and
    error information.
...
class Transcript:
    ...
    Attributes:
        format: Shunyalabs JSON transcript format version.
