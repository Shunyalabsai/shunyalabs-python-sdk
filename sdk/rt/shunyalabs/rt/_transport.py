...
class Transport:
    """
    WebSocket transport layer for Shunyalabs RT API communication.
    ...
    def __init__(
        ...
        Args:
            url: The base URL for the Shunyalabs RT API.
        ...
        self._closed = False
        self._logger = get_logger("shunyalabs.rt.transport")
    ...
    async def connect(self, ws_headers: Optional[dict] = None) -> None:
        """
        Establish WebSocket connection to the Shunyalabs RT API.
    ...
    async def receive_message(self) -> dict:
        ...
        Returns:
            ...
            message type received from the Shunyalabs RT API.
