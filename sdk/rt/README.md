# Shunyalabs Real-Time API Client

[![PyPI](https://img.shields.io/pypi/v/shunyalabs-rt)](https://pypi.org/project/shunyalabs-rt/)
![PythonSupport](https://img.shields.io/badge/Python-3.9%2B-green)

Async Python client for the Shunyalabs Real-Time API.
...
```python
import asyncio
from shunyalabs.rt import AsyncMultiChannelClient, ServerMessageType, TranscriptionConfig
...
```python
from shunyalabs.rt import AsyncClient, JWTAuth

# Create JWT auth (requires: pip install 'shunyalabs-rt[jwt]')
...
- `SHUNYALABS_RT_URL`: Custom API endpoint URL (optional)
