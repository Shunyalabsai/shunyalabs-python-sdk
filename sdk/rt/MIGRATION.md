...
This guide helps users migrate from the legacy Shunyalabs Real-Time Client (`Shunyalabs-python`) to the new Shunyalabs Real-Time SDK (`shunyalabs-rt`). The new SDK provides a cleaner API, better error handling, and improved performance with minimal dependencies.
...
- **Import paths**: `Shunyalabs.client` → `shunyalabs.rt`
...
```python
from shunyalabs.client import WebsocketClient
from shunyalabs.models import TranscriptionConfig
...
```python
from shunyalabs.rt import AsyncClient, TranscriptionConfig
...
```python
from shunyalabs.client import WebsocketClient
from shunyalabs.models import ServerMessageType, TranscriptionConfig
...
```python
from shunyalabs.rt import AsyncClient, TranscriptionConfig, ServerMessageType
...
```python
from shunyalabs.client import WebsocketClient
from shunyalabs.models import TranscriptionConfig, ConnectionConfig
...
```python
from shunyalabs.rt import AsyncClient, ConnectionConfig, TranscriptionConfig, JWTAuth
