"""
Asynchronous client for Shunyalabs TTS transcription.

This module provides the main AsyncClient class that handles text-to-speech
using the Shunyalabs TTS API.
"""
...
class AsyncClient:
    ...
    This client provides a full-featured async interface to the Shunyalabs TTS API,
    supporting job submission, monitoring, and result retrieval with comprehensive
    error management. It properly implements the Shunyalabs REST API.
    ...
    Args:
        ...
        url: REST API endpoint URL. If not provided, uses SHUNYALABS_TTS_URL
    ...
    Examples:
        ...
        With JWT authentication:
            >>> from shunyalabs.batch import JWTAuth
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            url: REST API endpoint URL. If None, uses SHUNYALABS_TTS_URL env var
        ...
        self._url = url or os.environ.get("SHUNYALABS_TTS_URL") or "https://preview.tts.Shunyalabs.com"
